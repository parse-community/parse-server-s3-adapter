...
const optionsFromArguments = function optionsFromArguments(args) {
  ...
  if (typeof stringOrOptions == 'string') {
    ...
    if (otherOptions) {
      ...
      options.encrypt = otherOptions.encrypt;
  ...
  // options = fromEnvironmentOrDefault(options, 'encrypt', 'ENCRYPT', false)
  // options = fromEnvironmentOrDefault(options, 'encryptAlgorithm', 'ENCRYPT_ALGORITHM', 'AES256')
